...
module Waitlisted
  ...
  class ReservationsResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'referred_count')
        self.referred_count = attributes[:'referred_count']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          referred_count == o.referred_count &&
          position == o.position &&
    ...
    def hash
      [id, uuid, email, affiliate, name, referred_count, position, total_count, activated_at, created_at].hash
    end
